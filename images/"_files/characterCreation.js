...
var $leftArrows = $('.left_selection');
var $rightArrows = $('.right_selection');
var $submitButton = $('#submitAstronaut');
var $pageNumber = $('#pageNumber');
var pageNumber = 1;
  $pageNumber.text(pageNumber+'/4');
var flagPicturesIndex = 0;
var nameIndex = 0;
...
var $flagPicture = $('#showFlag');
var $charPortrait = $('.charPortrait');
var $charName = $('.charName');
var $charNationality = $('.charNationality');
var $charAge = $('.charAge');
var $charBackground = $('.charBackground');
var $charQuote = $('.charQuote');
...
function createCharacterEventListeners(){
  ...
  $leftArrows.on('click', function(e){
    ...
    if (e.target === $leftArrows[1])
    {
      ...
      $flagPicture.css('background', 'url(images/flags64/'+flagPictures[flagPicturesIndex])+'))';
